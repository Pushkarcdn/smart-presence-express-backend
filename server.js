...
app.listen(port, () => {
  ...
  console.log(`=================================`);
  console.log(`======= ENV: ${process.env.NODE_ENV} =======`); // Logs the current environment (development, production, etc.)
  console.log(`🚀 App listening on the port ${port}`); // Logs the port number where the server is runnin
  console.log(`=================================`);
});
